...
let some_number_key: number = 1.11
// ok: custom_object_injection_sink
console.log(some_json[some_number_key]);
...
function abcd(arg1, user_input: number, arg3) {
	// ok: custom_object_injection_sink
	console.log(some_json[user_input]);
}
...
function abcd(arg1, user_input: number) {
	// ok: custom_object_injection_sink
	console.log(some_json[user_input]);
}
...
function abcd(user_input: number, arg3) {
	// ok: custom_object_injection_sink
	console.log(some_json[user_input]);
}
...
function abcd(user_input: number) {
	// ok: custom_object_injection_sink
	console.log(some_json[user_input]);
}
...
let abcd = function(arg1, user_input: number, arg3) {
	// ok: custom_object_injection_sink
	console.log(some_json[user_input]);
}
...
let abcd = function(arg1, user_input: number) {
	// ok: custom_object_injection_sink
	console.log(some_json[user_input]);
}
...
let abcd = function(user_input: number, arg3) {
	// ok: custom_object_injection_sink
	console.log(some_json[user_input]);
}
...
let abcd = function(user_input: number) {
	// ok: custom_object_injection_sink
	console.log(some_json[user_input]);
}
